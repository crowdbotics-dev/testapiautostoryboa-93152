...
## Project Structure
    ...
    ├── testapiautostoryboa_93152  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_93152`
...
2. Clone this repo and `cd testapiautostoryboa_93152`
